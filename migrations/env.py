...
from extensions import db  # Import your db object
...
# Set up the app context for Alembic to work with Flask
with app.app_context():
    target_metadata = db.metadata  # Use SQLAlchemy's metadata for migrations
